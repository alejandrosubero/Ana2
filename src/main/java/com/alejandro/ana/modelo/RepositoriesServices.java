...
public class RepositoriesServices {
		...
		sb1.append("\r\n");
			...
			for (AtributoPojo atributos : listAtributos) {
				...
				if (!atributos.getsId()){
					...
					sb1.append("\r\n");
					sb1.append("		public List<" + entidad.getNombreClase() + "> findBy"+atributoName+"Containing("+atributos.getTipoDato()
	...
	private  void createService(EntidadesPojo entidad ) throws InterruptedException {
		...
		sb2.append("\r\n");
		sb2.append("		public boolean update"+entidad.getNombreClase()+"("+entidad.getNombreClase()+" "+entidad.getNombreClase().toLowerCase()+");");
		sb2.append("\r\n");
